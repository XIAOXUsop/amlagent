...
class WorkflowConsumerLagTest {
    ...
    void includesUndeliveredAndPendingMessages() {
        StreamInfo.XInfoGroup group = StreamInfo.XInfoGroup.fromList(List.of("name", "aml-workers", "consumers", 1L,
                "pending", 3L, "last-delivered-id", "10-0", "entries-read", 10L, "lag", 7L));
