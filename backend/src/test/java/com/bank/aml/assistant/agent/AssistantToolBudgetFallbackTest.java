...
class AssistantToolBudgetFallbackTest {
    ...
    void createsReadOnlySnapshotBoundAnswerThatPassesOutputGuard() {
        ...
        CustomerAssistantSnapshot snapshot = new CustomerAssistantSnapshot("s", "c", "r", Instant.EPOCH,
                ...
                new TransactionRiskView(120, new BigDecimal("497000000"), new BigDecimal("4141666.67"), 50.83, 32.5,
                        105, 2, List.of("CNY", "USD"), List.of("中国大陆"), true),
                new OwnershipRiskView(1, 1, List.of()), new SanctionRiskView(false, 0, 0, List.of()),
                List.of(new AssistantEvidence(evidenceId, AssistantEvidence.EvidenceType.TRANSACTION_AGGREGATE, "交易聚合",
                        "交易共120笔", "TEST/v1")),
        ...
        String answer = AssistantEvidenceCitationAppender.appendMissing(
                ...
                List.of(new AssistantToolTrace(1, "transaction", "SUCCESS", 1, "digest", List.of(evidenceId), null)));
