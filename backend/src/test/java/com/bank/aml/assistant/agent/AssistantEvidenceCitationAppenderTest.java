...
class AssistantEvidenceCitationAppenderTest {
    ...
    void appendsOnlyUniqueEvidenceFromSuccessfulTools() {
        ...
        String result = AssistantEvidenceCitationAppender.appendMissing("结论",
                List.of(new AssistantToolTrace(1, "tx", "SUCCESS", 1, "digest", List.of(tx), null),
                        new AssistantToolTrace(2, "evidence", "SUCCESS", 1, "digest", List.of(tx, legal), null),
                        new AssistantToolTrace(3, "invalid", "INVALID_ARGUMENT", 1, null, List.of("KB-MUST-NOT-APPEAR"),
                                "INVALID_ARGUMENT")));
    ...
    void doesNotDuplicateEvidenceAlreadyCitedByModel() {
        ...
        assertThat(AssistantEvidenceCitationAppender.appendMissing(answer,
                List.of(new AssistantToolTrace(1, "search", "SUCCESS", 1, "digest", List.of(evidence), null))))
            .isEqualTo(answer);
    }
    ...
    void replacesModelWrittenEvidenceWithServerVerifiedToolEvidence() {
        ...
        String result = AssistantEvidenceCitationAppender.normalizeAndAppend("事实引用 `" + invented + "`。",
                List.of(new AssistantToolTrace(1, "tx", "SUCCESS", 1, "digest", List.of(verified), null)));
