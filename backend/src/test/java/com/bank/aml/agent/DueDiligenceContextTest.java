...
class DueDiligenceContextTest {
    ...
    private static InvestigationAlertSnapshot alert(long id, String externalId, String scenario, String reason) {
        return new InvestigationAlertSnapshot(id, externalId, "RULE-" + id, scenario, reason,
                LocalDateTime.of(2026, 8, 1, 23, 30), 0);
    }

    @Test
    void promptDistinguishesTrustedAndUntrustedFields() {
        var ctx = new DueDiligenceContext(1L, "C001", "企业法人", "2026-08-13", List.of("跨境", "夜间"), List.of(), "大额频繁跨国转账",
                "请尽调");
    ...
    void promptContainsOnlyOpaqueCustomerReferenceForTools() {
        var ctx = new DueDiligenceContext(1L, "C002", "个人", "2026-08-13", List.of("现金"), List.of(), "拆分交易", "请尽调");
    ...
    void promptRendersEachLinkedAlertWithIdScenarioAndReason() {
        var ctx = new DueDiligenceContext(7L, "C001", "企业法人", "2026-08-13", List.of("跨境", "夜间", "拆分"),
    ...
    void promptNotesMissingAlertsExplicitly() {
        var ctx = new DueDiligenceContext(7L, "C001", "企业法人", "2026-08-13", List.of("尽职调查"), List.of(), "常规监测", "请尽调");
