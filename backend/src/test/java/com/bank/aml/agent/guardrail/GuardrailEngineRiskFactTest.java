...
/**
 * 验证生产链路 GuardrailEngine 从 Mock 数据正确计算新增风险事实 （dataComplete / patternSeverity /
 * uboRiskSeverity），使新增规则真实可触发。
 */
class GuardrailEngineRiskFactTest {
    ...
    void c001ComplexUboTriggersUboUnverifiedRule() {
        ...
        assertThat(result.decision().triggeredRules()).extracting(r -> r.ruleCode())
