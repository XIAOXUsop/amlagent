...
class KeywordLegalSearcherIntegrationTest {
    ...
    void bindsScoreConditionsAndVersionInSqlOrder() {
        var request = new RetrievalRequest("公司账户两百万元大额交易报告", "大额交易", Instant.parse("2026-08-01T00:00:00Z"), "CN",
                Set.of("PUBLIC_LEGAL"), 5, 0.04, RetrievalTarget.SPECIFIC_VERSION, VERSION,
    ...
    private static void insert(String text, String title, String documentNumber, String article, String evidenceId) {
        ...
        jdbc.update("INSERT INTO " + QUOTED_TABLE + " (text, metadata) VALUES (?, ?::jsonb)", text, metadata);
    }
