...
class CachingLegalSearcherVersionTest {
    ...
    void actualActiveCorpusHashSeparatesCacheEntries() {
        ...
        CachingLegalSearcher searcher = new CachingLegalSearcher(delegate, redis, metrics, new ObjectMapper(), 60,
                versions, "embedding-v1", "reranker-v1");
        ...
        verify(delegate, times(2)).search("客户尽职调查", 3);
    }
    ...
    void authorizationScopeAndAsOfDateSeparateCacheEntries() {
        ...
        RetrievalRequest publicRequest = new RetrievalRequest("客户尽调", "尽调", Instant.parse("2026-01-01T00:00:00Z"), "CN",
                Set.of("PUBLIC_LEGAL"), 3, 0.04);
        RetrievalRequest internalRequest = new RetrievalRequest("客户尽调", "尽调", Instant.parse("2026-01-01T00:00:00Z"),
                "CN", Set.of("AML_INTERNAL"), 3, 0.04);
