...
public class InvestigationController {
    ...
    public InvestigationController(InvestigationService investigation,
    ...
    @GetMapping
    public CaseInvestigationView get(@PathVariable Long caseId) { return investigation.get(caseId); }
    ...
    public InvestigationEvidenceView addEvidence(@PathVariable Long caseId, @PathVariable Long hypothesisId,
        ...
        return investigation.addEvidence(caseId, hypothesisId, request.evidenceType(),
                request.evidenceReference(), request.stance(), request.findingSummary(), authentication.getName());
    }

    @PutMapping("/hypotheses/{hypothesisId}")
    @PreAuthorize("hasAnyRole('ANALYST','ADMIN')")
    public InvestigationHypothesisView updateHypothesis(
            @PathVariable Long caseId, @PathVariable Long hypothesisId,
