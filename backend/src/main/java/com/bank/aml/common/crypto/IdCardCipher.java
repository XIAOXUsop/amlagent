package com.bank.aml.common.crypto;
...
public final class IdCardCipher {
    ...
    public static final String DEV_KEY = "0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef";
    ...
    public static String decrypt(String stored) {
        if (!isEncrypted(stored))
            return stored; // 仅供 V6 上线时读取尚未重加密的历史值
        try {
