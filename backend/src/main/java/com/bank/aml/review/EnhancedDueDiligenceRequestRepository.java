...
public interface EnhancedDueDiligenceRequestRepository extends JpaRepository<EnhancedDueDiligenceRequest, Long> {
    ...
    List<EnhancedDueDiligenceRequest> findByAssignedToAndStatusOrderByDueAtAsc(String assignedTo,
    ...
    List<EnhancedDueDiligenceRequest> findByCaseIdAndStatusOrderByIdAsc(Long caseId, EnhancedDueDiligenceStatus status);
    ...
    @Query("""
            ...
            """)
    int submitResponse(@Param("id") Long id, @Param("caseId") Long caseId,
            @Param("open") EnhancedDueDiligenceStatus open, @Param("submitted") EnhancedDueDiligenceStatus submitted,
            @Param("expectedRevision") int expectedRevision, @Param("summary") String summary,
            @Param("referencesJson") String referencesJson, @Param("respondedBy") String respondedBy,
    ...
    @Query("""
            ...
            """)
    int completeTask(@Param("id") Long id, @Param("caseId") Long caseId,
            @Param("submittedStatus") EnhancedDueDiligenceStatus submittedStatus,
            @Param("resolved") EnhancedDueDiligenceStatus resolved, @Param("expectedRevision") int expectedRevision,
            @Param("reason") String reason, @Param("resolvedBy") String resolvedBy,
