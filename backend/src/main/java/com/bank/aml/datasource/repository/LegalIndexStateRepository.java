...
public interface LegalIndexStateRepository extends JpaRepository<LegalIndexStateEntity, String> {
    ...
    @Query("""
            ...
            """)
    int claimBuild(@Param("version") String version, @Param("owner") String owner, @Param("now") LocalDateTime now,
    ...
    @Query("""
            ...
            """)
    int renewBuildLease(@Param("version") String version, @Param("owner") String owner, @Param("now") LocalDateTime now,
            @Param("leaseUntil") LocalDateTime leaseUntil);
    ...
    @Query("""
            ...
            WHERE s.id = 'legal' AND s.buildOwner = :owner AND s.buildingVersion = :version
            """)
    int releaseBuild(@Param("version") String version, @Param("owner") String owner, @Param("now") LocalDateTime now);
