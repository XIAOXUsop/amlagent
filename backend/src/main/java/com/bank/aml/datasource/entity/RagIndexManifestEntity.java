...
public class RagIndexManifestEntity {
    ...
    public void setIndexVersion(String v) {
        this.indexVersion = v;
    }
    ...
    public void setCorpusHash(String v) {
        this.corpusHash = v;
    }
    ...
    public void setMetadataSchemaVersion(String v) {
        this.metadataSchemaVersion = v;
    }
    ...
    public String getEmbeddingRevision() {
        return embeddingRevision;
    }

    public void setEmbeddingRevision(String v) {
        this.embeddingRevision = v;
    }

    public String getEmbeddingModelHash() {
        return embeddingModelHash;
    }

    public void setEmbeddingModelHash(String v) {
        this.embeddingModelHash = v;
    }
    ...
    public void setDistanceMetric(String v) {
        this.distanceMetric = v;
    }
    ...
    public void setQualityReportJson(String v) {
        this.qualityReportJson = v;
    }
    ...
    public void setActivatedAt(LocalDateTime v) {
        this.activatedAt = v;
    }
    ...
    public void setRetiredAt(LocalDateTime v) {
        this.retiredAt = v;
    }
