...
public class InvestigationSnapshotEntity {
    ...
    @Column(nullable = false, length = 128)
    private String legalIndexVersion;
    ...
    public void setAsOfTime(Instant asOfTime) {
    ...
    public String getAlertsDigest() {
        return alertsDigest;
    }

    public void setAlertsDigest(String alertsDigest) {
        this.alertsDigest = alertsDigest;
    }
    ...
    public void setPayloadCiphertext(String payloadCiphertext) {
