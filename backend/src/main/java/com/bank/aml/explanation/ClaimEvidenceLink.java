...
/**
 * 事实-证据关联（v3 计划 §9）：claim → 材料版本/核验事件。
 * 同时保留反证（SUPPORTS/CHALLENGES）；sourceFamily 标注同源家族（同源多文件不累计独立确认）；
 * 定位必须属于相应内容版本。
 */
@Entity
...
public class ClaimEvidenceLink {
    ...
    public void setClaimId(Long value) { claimId = value; }
    ...
    public Long getVerificationEventId() { return verificationEventId; }
    public void setVerificationEventId(Long value) { verificationEventId = value; }
    public String getDirection() { return direction; }
    public void setDirection(String value) { direction = value; }
    public String getSourceFamily() { return sourceFamily; }
    public void setSourceFamily(String value) { sourceFamily = value; }
