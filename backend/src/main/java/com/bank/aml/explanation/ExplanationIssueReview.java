...
/**
 * 问题重要性降级双人确认记录（验收 A5-04）。 降级采用提案-确认两步流程：分析员创建提案；另一位已认证 REVIEWER/ADMIN 在独立请求中确认。
...
public class ExplanationIssueReview {
    ...
    public void setProposalRevision(int value) {
        proposalRevision = value;
    }

    public int getIssueRevision() {
        return issueRevision;
    }

    public void setIssueRevision(int value) {
        issueRevision = value;
    }

    public IssueSeverity getOriginalSeverity() {
        return originalSeverity;
    }

    public void setOriginalSeverity(IssueSeverity value) {
        originalSeverity = value;
    }

    public IssueSeverity getProposedSeverity() {
        return proposedSeverity;
    }

    public void setProposedSeverity(IssueSeverity value) {
        proposedSeverity = value;
    }
    ...
    public void setProposedBy(String value) {
        proposedBy = value;
    }
    ...
    public void setProposedAt(LocalDateTime value) {
        proposedAt = value;
    }
