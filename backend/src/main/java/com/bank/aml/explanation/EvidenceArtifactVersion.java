...
/**
 * 材料证据版本（v2 计划 §11.3）：正文不可更新；撤销/变更通过追加版本与事件表达。 保存实际取得内容的哈希与声称哈希；哈希一致只说明内容一致，不自动授予“业务真实”。
 */
@Entity
...
public class EvidenceArtifactVersion {
    ...
    /**
     * 实际取得内容哈希；未取得内容（NOT_FOUND/UNAVAILABLE/FORBIDDEN）时为 null（A6-06/V31：列已放宽 + CHECK 保证
     * RESOLVED 必有摘要）。
     */
    ...
    public void setClaimedSha256(String value) {
        claimedSha256 = value;
    }
    ...
    public void setIntegrityStatus(String value) {
    ...
    public void setPeriodFrom(LocalDateTime value) {
        periodFrom = value;
    }
    ...
    public void setPeriodTo(LocalDateTime value) {
        periodTo = value;
    }
    ...
    public void setSourceChain(String value) {
        sourceChain = value;
    }
