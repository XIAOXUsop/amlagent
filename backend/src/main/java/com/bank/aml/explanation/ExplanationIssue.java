...
/**
 * 问题（差异/反证/缺口）登记（v2 计划 §6/§12）。 稳定 issueKey；待分派新材料挂案件级（unitId=NULL）；不可静默删除。
 */
@Entity
...
public class ExplanationIssue {
    ...
    public IssueDisposition getDisposition() {
        return disposition;
    }

    public void setDisposition(IssueDisposition value) {
        disposition = value;
    }
    ...
    public void setDispositionReason(String value) {
