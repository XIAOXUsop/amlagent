...
public class AssistantSnapshotEntity {
    ...
    public static AssistantSnapshotEntity create(String snapshotId, String runId, String payload, String sourceDigest,
            String sourceSystem, String sourceVersion, String knowledgeIndexVersion, LocalDateTime asOfTime) {
    ...
    public String payload() {
        return SensitivePayloadCipher.decrypt(payloadCiphertext);
    }
    ...
    public String getKnowledgeIndexVersion() {
