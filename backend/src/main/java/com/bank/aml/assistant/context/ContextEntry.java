 ...
 */
public record ContextEntry(String entryId, ContextEntryKind kind, String messageId, long sequenceNo, String content,
        int tokenEstimate, List<String> evidenceIds, String archiveRef) {
    ...
    public ContextEntry withContent(String newContent, int newTokenEstimate, String newArchiveRef) {
        return new ContextEntry(entryId, kind, messageId, sequenceNo, newContent, newTokenEstimate, evidenceIds,
                newArchiveRef);
    }
}
