 ...
 * <ul>
 * <li>{@code status}：检索结果状态（SUPPORTED / WEAK_SUPPORT 语义由上游判定，这里存 RetrievalResponse.Status
 * 名与 support 原因）；</li>
 ...
 * </ul>
 */
public record RetrievalStatusView(String status, Double supportProbability, String indexVersion,
        String queryFingerprint, List<String> rejectedReasons, String traceId) {

    public static final RetrievalStatusView NONE = new RetrievalStatusView("", null, "", "", List.of(), "");
