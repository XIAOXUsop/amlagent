 ...
 * <p>
 * 预警规则来自请求侧，不能把其中的文字当作受信授权来跳过 Agent； 在引入服务端签名的路由元数据前，所有业务工单都必须执行主 Agent。
 * </p>
 */
@Component
public class CostRouter {

    private static final List<String> HIGH_RISK_KEYWORDS = List.of("制裁", "黑名单", "名单", "跨境", "夜间", "拆分", "现金", "UBO",
