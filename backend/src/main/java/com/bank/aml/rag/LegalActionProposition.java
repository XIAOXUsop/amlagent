...
/**
 * 人工审核的法律命题：把"冻结/报告/停止服务"等高影响处置动作的结构化语义建模为可验证条目， 用于替换关键词共现式支持校验。
 * <ul>
 ...
 * </ul>
 */
public record LegalActionProposition(String actionCode, String modality, String subject, String object,
        List<String> conditions, List<String> exceptions, String evidenceTitle, String evidenceId, String effectiveFrom,
        List<String> actionTerms, List<String> modalityTerms) {
