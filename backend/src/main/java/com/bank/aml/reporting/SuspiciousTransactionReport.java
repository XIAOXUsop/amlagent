...
public class SuspiciousTransactionReport {
    ...
    void onCreate() {
        ...
        if (updatedAt == null)
            updatedAt = now;
        if (status == null)
            status = SuspiciousTransactionReportStatus.PENDING_SUBMISSION;
    }
    ...
    public SuspiciousTransactionReportStatus getStatus() {
        return status;
    }

    public void setStatus(SuspiciousTransactionReportStatus status) {
        this.status = status;
    }
