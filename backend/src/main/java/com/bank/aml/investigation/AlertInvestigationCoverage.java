...
public class AlertInvestigationCoverage {
    ...
    private AlertCoverageConclusion conclusion;
    ...
    void onCreate() {
        ...
        if (conclusion == null)
            conclusion = AlertCoverageConclusion.PENDING;
        if (createdAt == null)
            createdAt = now;
        if (updatedAt == null)
            updatedAt = now;
    ...
    public Long getHypothesisRevision() {
        return hypothesisRevision;
    }

    public void setHypothesisRevision(Long value) {
        hypothesisRevision = value;
    }

    public Long getUnitSubmissionId() {
        return unitSubmissionId;
    }

    public void setUnitSubmissionId(Long value) {
        unitSubmissionId = value;
    }

    public AlertCoverageConclusion getConclusion() {
        return conclusion;
    }

    public void setConclusion(AlertCoverageConclusion value) {
        conclusion = value;
    }
    ...
    public void setAnalysisSummary(String value) {
