...
public class AmlAlert {
    ...
    public String getTriggerTransactionIds() {
        return triggerTransactionIds;
    }

    public void setTriggerTransactionIds(String value) {
        triggerTransactionIds = value;
    }

    public String getAuxiliaryTransactionIds() {
        return auxiliaryTransactionIds;
    }

    public void setAuxiliaryTransactionIds(String value) {
        auxiliaryTransactionIds = value;
    }

    public String getScopeSourceVersion() {
        return scopeSourceVersion;
    }

    public void setScopeSourceVersion(String value) {
        scopeSourceVersion = value;
    }

    public LocalDateTime getScopeFrozenAt() {
        return scopeFrozenAt;
    }

    public void setScopeFrozenAt(LocalDateTime value) {
        scopeFrozenAt = value;
    }

    public String getScopeFrozenBy() {
        return scopeFrozenBy;
    }

    public void setScopeFrozenBy(String value) {
        scopeFrozenBy = value;
    }
    ...
    public void setHitReason(String value) {
        hitReason = value;
    }
