...
public class InvestigationHypothesis {
    ...
    @Column(nullable = false, length = 96) private String hypothesisCode;
    @Column(nullable = false, length = 160) private String title;
    @Column(nullable = false, length = 500) private String investigationQuestion;
    @Column(nullable = false, length = 500) private String requiredEvidenceTypes;
    @Enumerated(EnumType.STRING) @Column(nullable = false, length = 32) private HypothesisStatus status;
    ...
    @PrePersist void onCreate() {
        ...
        if (status == null) status = HypothesisStatus.OPEN;
    ...
    public void setHypothesisCode(String value) { hypothesisCode = value; }
    public String getTitle() { return title; }
    public void setTitle(String value) { title = value; }
    public String getInvestigationQuestion() { return investigationQuestion; }
    public void setInvestigationQuestion(String value) { investigationQuestion = value; }
    public String getRequiredEvidenceTypes() { return requiredEvidenceTypes; }
    public void setRequiredEvidenceTypes(String value) { requiredEvidenceTypes = value; }
    public HypothesisStatus getStatus() { return status; }
    public void setStatus(HypothesisStatus value) { status = value; }
