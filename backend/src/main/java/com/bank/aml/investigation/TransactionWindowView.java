...
public record TransactionWindowView(
        Instant asOfTime,
        String sourceSystem,
    ...
    public record Window(
            ...
            List<CurrencySummary> currencyBreakdown,
            long crossBorderCount,
            long nightCount,
            List<CounterpartySummary> topCounterparties
    ) { }
    ...
    public record CounterpartySummary(String counterparty, long transactionCount,
